...
-- CLIENTS
INSERT INTO clients VALUES ('4546221', 'Johannes', 'Kepler', 3104583224, 'Cl 3 # 33 - 33', 'kepler@me.com');
INSERT INTO clients VALUES ('2552243', 'Galileo', 'Galilei', 3462257293, 'Cl 1 # 11 - 11', 'gali@leo.com');
INSERT INTO clients VALUES ('983824', 'Nicolás', 'Copernico', 3019392466, 'Cl 2 # 22 - 22', 'nico@cope.com');

-- SALE
INSERT INTO sale VALUES (1, '4546221', TO_TIMESTAMP('10/08/1992 17:30:00','DD/MM/YYYY HH24:MI:SS'), 'E', '', 'P');
INSERT INTO sale_product VALUES (1, 1, 10, 3000, true);
INSERT INTO sale_product VALUES (1, 36, 1, 40000, true);
INSERT INTO sale_product VALUES (1, 27, 1, 9000, true);
INSERT INTO sale_product VALUES (1, 49, 2, 16400, true);
INSERT INTO sale_product VALUES (1, 24, 1, 4000, true);

SELECT setval('public.product_id_product_seq', 50, true);
SELECT setval('public.category_id_category_seq', 8, true);
SELECT setval('public.sale_id_sale_seq', 1, true);